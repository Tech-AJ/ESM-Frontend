...
export default class participate2 extends Component {
    ...
    webView = {
      ...
      //  url: 'https://www.cse.iitk.ac.in/users/apoorvaj/procast/index.html',
        url:'https://srivalab-compute.cse.iitk.ac.in/restaurant/ExperimentC/',
...
// true;`;
    ...
    render() {
        const jsCode = //`document.querySelector('.HeaderHero').style.backgroundColor = 'purple';
            `document.querySelector("#next").style.backgroundColor = 'green';   //startTask
    document.querySelector('#next').addEventListener("click", function() {
    console.log("inside event");
   window.ReactNativeWebView.postMessage(JSON.stringify({type: "click", message : "ok", score: 
  variance }));
   });
true;`;
